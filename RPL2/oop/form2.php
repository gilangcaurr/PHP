...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent" >
   ...
   <div class="card mt-5 ml-5 mr-5"  style="background-color: #ADFF2F;">
    <div class="card-header">
        Form Data Orang Tua
    </div>
    <div class="card-body" style="background-color: #ADFF2F;">
        ...
        <form>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="tanggal_lahir_ayah" id="exampleInputDate">
            </div>
            <div class="form-group">
                <label for="exampleInputDate">Nama Ibu</label>
                <input type="text" class="form-control" name="nama_ibu" id="exampleInputName2"> 
            </div> 
            <div class="form-group">
                <label for="exampleInputDate">Tanggal Lahir Ibu</label>
                <input type="date" class="form-control" name="tanggal_lahir_ibu" id="exampleInputDate"> 
            </div>
...
?>
  <center>
   <div class="card text-white bg-success mb-3" style="max-width: 35rem; margin-top: 20rem: margin-bottom: 20rem:">
  ...
  <div class="card-body">
    ...
    <table>
      ...
      <tr>
        ...
        <td>:</td> 
        <td><?php echo $tanggal_lahir_ayah; ?></td>
      </tr> 
      <tr>
        <td>Nama Ibu</td> 
        <td>:</td> 
      ...
      <tr>
        ...
        <td>:</td> 
        <td><?php echo $tanggal_lahir_ibu; ?></td>
      </tr> 
    </table>
  </div>
</div>
